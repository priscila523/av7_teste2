$(function() { 
    ...
    $('#modalIncluirProfissional').on('shown.bs.modal', function (e) {
     ...
     $(document).on("click", "#btIncluirProfissional", function() {
        ...
        $.ajax({
            url: 'http://localhost:5000'+'/incluir_profissional',
            type: 'POST',
            dataType: 'json',
            contentType: 'application/json', 
            data: dados,
    ...
    $(document).on("click", ".excluir_profissional", function() {
        ...
        $.ajax({
            url: 'http://localhost:5000/excluir_profissional/'+id_profissional,
            type: 'DELETE', 
            dataType: 'json', 
    ...
    $('#modalIncluirCargo').on('shown.bs.modal', function (e) {
     ...
     $(document).on("click", "#btIncluirCargo", function() {
        ...
        $.ajax({
            url: 'http://localhost:5000'+'/incluir_cargo',
            type: 'POST',
            dataType: 'json', 
            contentType: 'application/json', 
            data: dados, 
    ...
    $(document).on("click", ".excluir_cargo", function() {
        ...
        $.ajax({
            url: 'http://localhost:5000/excluir_cargo/'+id_cargo,
            type: 'DELETE', 
            dataType: 'json', 
    ...
    $('#modalIncluirEmpresa').on('shown.bs.modal', function (e) {
     ...
     $(document).on("click", "#btIncluirEmpresa", function() {
        ...
        $.ajax({
            url: 'http://localhost:5000'+'/incluir_empresa',
            type: 'POST',
            dataType: 'json', 
            contentType: 'application/json', 
            data: dados, 
    ...
    $(document).on("click", ".excluir_empresa", function() {
        ...
        $.ajax({
            url: 'http://localhost:5000/excluir_empresa/'+empresa_id,
            type: 'DELETE', 
            dataType: 'json', 
